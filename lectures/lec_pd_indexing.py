...
# If part of the slice is not included in the Index, Pandas will not raise an exception.
# Instead, an empty DF is returned
...
# Useful when data frame of a single row is desired
...
x = ser.iloc[[0, 2]] # --> Take 1st and 3rd rows
print(x)
...
# (2) If either `start_label` or `end_label` not included in the index
# Result depends on whether the index is sorted
#
